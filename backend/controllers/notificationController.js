...
exports.getNotificationByUser = catchAsync(async (req, res) => {
...
exports.newLikeNotifiaction = catchAsync(
...
exports.removeLikeNotification = catchAsync(
  async (userId, postId, userToNotifyId) => {
    const notifications = await Notification.find({
      userToNotify: userToNotifyId,
    });
...
exports.newFollowNotification = catchAsync(
...
exports.removeFollowNotification = catchAsync(
  async (userId, userToNotifyId) => {
    const notifications = await Notification.find({
      userToNotify: userToNotifyId,
    });
